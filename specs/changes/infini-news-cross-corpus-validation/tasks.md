...
- [ ] Freeze pilot/full request manifest before scoring.
- [ ] Implement unchanged-artifact external evaluator.
- [ ] Generate no-text predictions, metrics, time groups, confound slices, and checksums.
- [ ] Run focused and repository acceptance tests.
- [ ] Independently review the final diff and evidence.
- [ ] Push the feature branch and open a research-only PR.

No production integration or deployment is in scope.
